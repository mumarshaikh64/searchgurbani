                    ...
                    <div className='row'>
                        <div className='col-lg-12 p-0'>
                            <div className='center-align'>
                                {props.headingData.pauri_info && props.headingData.pauri_info[0] && (
                                    <>
                                        <h2 className='text-dark'>{props.headingData.pauri_info[0].pauri_name_roman}</h2>
                                        <h3 className='text-dark'>{props.headingData.pauri_info[0].pauri_name_punjabi}</h3>
                                    </>
                                )}
                            </div>
                        </div>
                ...
                <div className='row'>
                    <div className='col-lg-12 p-0'>
                        <div className='d-flex justify-content-center'>
                            {props.poet === 'bgv' ?
                                <h6 className=' text-dark' >Displaying Vaar {props.headingData.current_vaar}, Pauri {props.headingData.current_pauri} of {props.headingData.pauri_count}</h6> :
                                <h6 className=' text-dark' >Displaying {props.headingData.current_page} of {props.pageto}</h6>}
                        </div>
                    </div>
                </div>
                <div className='container'>
                                            ...
                                            {props.poet === 'ggs' ? (
                                                <>
                                                    ...
                                                    {isAttrib ? <>
                                                        ...
                                                        <h2 className='lang-5' >{item.raag + " " + item.author}</h2></> : null}
                                                </>
                                            ): props.poet === 'ak' ? (
                                                <>
                                                    {isAttrib ?
                                                        <>
                                                            <h2 className='lang-4' >{item.lattrib} </h2>
                                                            <h2 className='lang-2' > <i>Shabad: {item.shabad_name}</i> </h2>
                                                            <h2 className='lang-5' >{item.raag + " " + item.author}</h2>
                                                        </> : null}
                                                </>
                                            ) : props.poet === 'bgv' ?(
                                                <>
                                                {isTeekaTransln ? <h2 className='lang-6' >{item.teeka}</h2> : null}
                                                       {isTeekaRomanTransln ? <h2 className='lang-6' >{item.teeka_roman}</h2> : null}
                                                       {isTeekaHindiTransln ? <h2 className='lang-6' >{item.teeka_hindi}</h2> : null}
                                                       {isAttrib ? <h2 className='lang-4' >{item.attributes} </h2> : null}
                                               </>
                                            ) : props.poet === 'dg' ?(
                                                <>
                                                {isTeekaTranslnDG ? <h2 className='lang-6' >{item.teeka}</h2> : null}
                                                </>
                                            ) : props.poet === 'ks' ?(
                                                <>
                                                {isTeekaTranslnKK ? <h2 className='lang-6' >{item.teeka_punjabi}</h2> : null}
                                                {isTeekaRomanTranslnKK ? <h2 className='lang-6' >{item.teeka_roman}</h2> : null}
                                                {isTeekaHindiTranslnKK ? <h2 className='lang-6' >{item.teeka_hindi}</h2> : null}
                                                {isAttrib ? <h2 className='lang-4' >{item.lattrib} </h2> : null}
                                                </>
                                            ) : props.poet === 'bnl' ?(
                                                <>
                                                {isTeekaTranslnBNL ? <h2 className='lang-6' >{item.teeka}</h2> : null}
                                                {isTeekaHindiTranslnBNL ? <h2 className='lang-6' >{item.teekahindi}</h2> : null}
                                                {isAttrib ? <h2 className='lang-4' >{item.attributes} </h2> : null}
                                                </>
                                            ) : null}
