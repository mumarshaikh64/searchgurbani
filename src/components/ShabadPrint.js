...
const ShabadPrint = (props) => {
    ...
    return (
        <div>
            ...
            <section className='inner-actions p-2' >
                ...
                <section className='section-shabad p-5'>
                    {props.poet === 'bnl' ?
                        <div className=''>
                            {/* <h3 className='text-dark mb-3 text-center' >{props.sheadingData.meta_titleE}</h3>*/}
                            <h3 className='text-dark mb-3 text-center' >{props.title}</h3> 
                            <p className='text-dark mb-2 text-center' ><b>{`This shabad is on page   ${props.angData[0]?.pageID}   of Bhai Nand Lal.`}</b></p>
                        </div>
                        : <div className=''>
                            <h3 className='text-dark mb-3 text-center' >{props.headingData.meta_titleE}</h3>
                            <h3 className='text-dark mb-3 text-center' >{props.headingData.meta_titleP}</h3>
                            <p className='text-dark mb-2 text-center' ><b>{props.headingData.meta_description}</b></p>
                        </div>}
                </section>
