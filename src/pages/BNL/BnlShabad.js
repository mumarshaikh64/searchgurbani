...
function BnlShabadLine() {
    ...
    const getShabadLines = async (id) => {
        setLoader(true)
        await ApiHelper.get(API.getBnlPages + type + '/shabad/' + id + "/line/" + lineno + '/title/' + data.Title)
            .then((resData) => {
                setLoader(false);
                        ...
                        <div className='col-lg-6 p-0'>
                            <div className='in-act-wrapper'>
                                <div className='actions-mains'>
                                    ...
                                    <button className='action-btn-main' onClick={() => window.open(`/bhai-nand-lal/${type}/${shabad_id}/line/${lineno}/${headingData?.title}/print-view`, '_blank', 'height=700,width=700')}><i class="bi bi-printer"></i></button>
