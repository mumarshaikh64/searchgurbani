                            ...
                            <div className='col-lg-6 p-0'>
                                <div className='in-act-wrapper'>
                                    <div className='actions-mains'>
                                        ...
                                        <button className='action-btn-main' onClick={() => window.open(`/bhai-nand-lal/${type}/verse/${page_no}/print-view`, '_blank', 'height=700,width=700')}><i class="bi bi-printer"></i></button>
