                                    ...
                                    return (
                                        <div className='ang-itm padd-indexx ' >
                                            <div className="section_line line row1">
                                                ...
                                                <Link to={`/sri-nanak-prakash/page/${item.page_id}/volume/${chapterId}`} className="col_sl_no sec-nos">
                                                    <span >{item.chapter_name}</span></Link>
                                                <Link to={`/sri-nanak-prakash/page/${item.page_id}/volume/${chapterId}`}className="col_section_no sec-no page-no" >
