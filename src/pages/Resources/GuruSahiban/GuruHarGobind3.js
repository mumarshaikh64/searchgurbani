            ...
            <section className='section-1'>
                ...
                <div className='Gurbani-Raags p-4'>
                                ...
                                {datas ?
                                    ...
                                    < div className='dates'
                                        dangerouslySetInnerHTML={{
                                            __html: datas.html
                                                ?.replace('src=\"..\/assets\/img\/res\/gharg7.jpg\"', `src="${gharg7}"`)
                                                .replace('src=\"..\/assets\/img\/res\/gharg4.jpg\"', `src="${gharg4}"`)
                                                .replace('src=\"..\/assets\/img\/res\/gharg9.jpg\"', `src="${gharg9}"`)
                                        }}
                                    /> : null}
                            </div>
                        </div>
                    ...
                    <hr></hr>
                        ...
                        <div className='col-lg-4 page-content center-algn-next'><Link to='/gurus/guruhargobindi2'>Back</Link></div>
                        <div className='col-lg-4  page-content right-algn-next'><Link to='/gurus/guruhargobindi4'>Next</Link></div>
                        </div>
                </div>
        </div>
