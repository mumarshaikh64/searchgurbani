            ...
            <section className='section-1'>
                ...
                <div className='Gurbani-Raags p-4'>
                                ...
                                {datas ?
                                    ...
                                    < div className='dates'
                                        dangerouslySetInnerHTML={{
                                            __html: datas.html
                                                ?.replace('src=\"assets\/img\/res\/gobind19.jpg\"', `src="${gobind19}"`)
                                                .replace('src=\"assets\/img\/res\/gobind5.jpg\"', `src="${gobind5}"`)
                                        }}
                                    /> : null}
                            </div>
                        </div>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-lg-4 page-content center-algn-next'><Link to='/gurus/gurugobind7'>Back</Link></div>
                        <div className='col-lg-4  page-content right-algn-next'><Link to='/gurus/gurugobind9'>Next</Link></div>
                        </div>
                </div>
        </div>
