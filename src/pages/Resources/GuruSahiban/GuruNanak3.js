        ...
        <div>
            ...
            <section className='section-1'>
                ...
                <div className='row'>
                        ...
                        <div className='col-lg-4 page-content center-algn-next'><Link to='/gurus/gurunanak2'>Back</Link></div>
                        <div className='col-lg-4  page-content right-algn-next'><Link to='/gurus/gurunanak4'>Next</Link></div>
                        </div>
                    </div>
                </div>
