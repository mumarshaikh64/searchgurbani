    ...
    return (
        <div>
            ...
            <section className='section-1'>
                                ...
                                {datas ?
                                    ...
                                    < div className='dates'
                                        dangerouslySetInnerHTML={{
                                            __html: datas.html
                                                ?.replace('src=\"..\/assets\/img\/res\/gharg8.jpg\"', `src="${gharg8}"`)
                                                .replace('src=\"..\/assets\/img\/res\/gharg10.jpg\"', `src="${gharg10}"`)
                                        }}
                                    /> : null}
                            </div>
                        </div>
                ...
                <div className='page-content right-algn-next'><Link to='/gurus/guruhargobindi3'>Back</Link></div>
                </div>
        </div>
