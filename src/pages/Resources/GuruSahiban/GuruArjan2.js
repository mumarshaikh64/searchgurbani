            ...
            <section className='section-1'>
                ...
                <div className='Gurbani-Raags p-4'>
                    ...
                    <div className="row ">
                                    ...
                                    {datas ?
                                        < div className='dates'
                                            dangerouslySetInnerHTML={{
                                                __html: datas.html
                                                    ?.replace('src=\"assets\/img\/res\/garjan2.jpg\"', `src="${garjan2}"`)
                                                    .replace('src=\"assets\/img\/res\/garjan1.jpg\" ', `src="${garjan1}"`)
                                                    .replace('src=\"assets\/img\/res\/garjan6.jpg\" ', `src="${garjan6}"`)
                                            }}
                                        /> : null}
                                </div>
                            </div>
                        ...
                        <div className='col-lg-4 page-content center-algn-next'><Link to='/gurus/guruarjun'>Back</Link></div>
                        <div className='col-lg-4  page-content right-algn-next'><Link to='/gurus/guruarjun3'>Next</Link></div>
                        </div>
                    </div>
                </div>               
