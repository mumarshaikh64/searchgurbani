    ...
    return (
        <div>
            ...
            <section className='section-1'>
                                ...
                                {datas ?
                                    ...
                                    < div className='dates'
                                        dangerouslySetInnerHTML={{
                                            __html: datas.html
                                                ?.replace('src=\"assets\/img\/res\/gobind9.jpg\"', `src="${gobind9}"`)
                                                .replace('src=\"assets\/img\/res\/gobind18.jpg\"', `src="${gobind18}"`)
                                        }}
                                    /> : null}
                            </div>
                        </div>
                ...
                <div className='page-content right-algn-next'><Link to='/gurus/gurugobind8'>Back</Link></div>
                </div>
        </div>
