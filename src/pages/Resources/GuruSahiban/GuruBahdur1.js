    ...
    return (
        <div>
            ...
            <section className='section-1'>
                                ...
                                {datas ?
                                    ...
                                    < div className='dates'
                                        dangerouslySetInnerHTML={{
                                            __html: datas.html
                                                ?.replace('src=\"..\/assets\/img\/res\/gtb5.jpg\"', `src="${gtb5}"`)
                                                .replace('src=\"..\/assets\/img\/res\/gtb4.jpg\"', `src="${gtb4}"`)
                                                .replace('src=\"..\/assets\/img\/res\/gtb10.jpg\"', `src="${gtb10}"`)
                                                .replace('src=\"..\/assets\/img\/res\/gtb6.jpg\"', `src="${gtb6}"`)
                                        }}
                                    /> : null}
                            </div>
                        </div>
                ...
                <div className='page-content right-algn-next'><Link to='/gurus/guruteghbhadur'>Back</Link></div>
                </div>
        </div>
