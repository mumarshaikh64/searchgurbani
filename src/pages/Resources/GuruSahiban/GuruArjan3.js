            ...
            <section className='section-1'>
                ...
                <div className='Gurbani-Raags p-4'>
                    ...
                    <div className="row ">
                                    ...
                                    {datas ?
                                        < div className='dates'
                                            dangerouslySetInnerHTML={{
                                                __html: datas.html
                                                    ?.replace('src=\"assets\/img\/res\/garjan5.jpg\"', `src="${garjan5}"`)
                                                    .replace('src=\"assets\/img\/res\/garjan9.jpg\"', `src="${garjan9}"`)
                                            }}
                                        /> : null}
                                </div>
                            </div>
                        ...
                        <div className='col-lg-4 page-content center-algn-next'><Link to='/gurus/guruarjun2'>Back</Link></div>
                        <div className='col-lg-4  page-content right-algn-next'><Link to='/gurus/guruarjun4'>Next</Link></div>
                        </div>
                    </div>
                </div>               
