    ...
    return (
        <div>
            ...
            <section className='section-1'>
                                    ...
                                    {datas ?
                                        < div className='dates'
                                            dangerouslySetInnerHTML={{
                                                __html: datas.html
                                                    ?.replace('src=\"assets\/img\/res\/garjan7.jpg\"', `src="${garjan7}"`)
                                                    .replace('src=\"assets\/img\/res\/garjan8.jpg\"', `src="${garjan8}"`)
                                            }}
                                        /> : null}
                                </div>
                            </div>
                ...
                <div className='page-content right-algn-next'><Link to='/gurus/guruarjun3'>Back</Link></div>
                    </div>
                </div>               
